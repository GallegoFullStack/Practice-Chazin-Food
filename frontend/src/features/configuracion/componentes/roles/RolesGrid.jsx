          ...
          <div key={rol.id} className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/60 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="border-t border-gray-100 dark:border-gray-700/60 pt-3 flex items-center justify-center gap-1.5 text-[10px] lg:text-[11px] font-medium whitespace-nowrap">
                ...
                <button
                  onClick={() => onEdit(rol)}
                  className="flex items-center gap-1 text-slate-700 dark:text-gray-300 hover:text-slate-900 transition-colors shrink-0"
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1 transition-colors shrink-0 ${rol.estado === "Activo" ? "text-amber-600" : "text-emerald-600"}`}
                >
                  {rol.estado === "Activo" ? <ToggleRight className="w-3 h-3 text-amber-500" /> : <ToggleLeft className="w-3 h-3 text-emerald-500" />}
                ...
                {onDelete && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center justify-center text-red-500 hover:text-red-600 transition-colors p-0.5 shrink-0"
                    >
